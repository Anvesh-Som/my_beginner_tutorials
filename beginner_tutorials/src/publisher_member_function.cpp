...
public:
  MinimalPublisher() : rclcpp::Node("minimal_publisher"), count_(0) {
    publisher_ = this->create_publisher<std_msgs::msg::String>(kTopic, 10);
    timer_ = this->create_wall_timer(
        500ms, std::bind(&MinimalPublisher::OnTimer, this));
  }
...
private:
  ...
  void OnTimer() {
    ...
    msg.data = "UMD Robotics says hi! seq=" + std::to_string(count_) +
